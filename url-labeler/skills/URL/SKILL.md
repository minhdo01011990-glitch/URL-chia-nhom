...
> 📂 **[1/6] Dữ liệu URL của bạn ở đâu?**
> Chấp nhận:
> - Đường dẫn file: `data.csv`, `data.xlsx`, `data.json`
> - Link Google Sheets: `https://docs.google.com/spreadsheets/d/...`
> - Dán trực tiếp danh sách URL vào chat

### Question 2 — Domain website

> 🌐 **[2/6] Domain của website là gì?**
> Ví dụ: `hacom.vn`, `thegioididong.com`
> _(Dùng để research cấu trúc website tự động — không cần mô tả thủ công)_

### Question 3 — Mục đích phân tích

> 🎯 **[3/6] Mục đích phân tích của bạn là gì?**
> Ví dụ:
...
> 🏷️ **[4/6] Nhãn mẫu của bạn** _(quan trọng nhất)_
> Cung cấp **3–10 nhãn** theo đúng phong cách đặt tên bạn muốn.
> AI sẽ dùng các nhãn này làm khuôn mẫu cho toàn bộ taxonomy.
>
...
> Trang tĩnh - Liên hệ
> ```
> Nhãn mới sẽ theo đúng cấu trúc tên mẫu của bạn.

### Question 5 — Đường dẫn output

> 📁 **[5/6] Lưu kết quả vào đâu?**
> Nhập đường dẫn file Excel _(hoặc Enter để dùng mặc định)_
> Mặc định: `./labeled_output.xlsx`
...
────────────────────────────────────────
Tổng hàng:    18,000
Cột nhận dạng: URL, Keywords, Organic Traffic
Session ID:   abc123-def456

Mẫu URL:
  https://hacom.vn/
  https://hacom.vn/laptop/
  https://hacom.vn/laptop/macbook-pro-m3.html
  https://hacom.vn/tin-tuc/review-macbook.html
  ...
────────────────────────────────────────
```
...
✓ Merge hoàn tất
────────────────────────────────────────
  Succeeded:   2,100 hàng  ✓
  Replaced:       12 hàng  ⚠ (nhãn ngoài taxonomy → "Chưa phân loại")
  Failed:          0 hàng
  Skipped:         0 hàng
────────────────────────────────────────
```
...
────────────────────────────────────────
  ...
  Kích thước: ~2.4 MB
  Tổng hàng:  18,000
  Cột:        url | label | confidence | method
────────────────────────────────────────
```
